                ...
                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    ...
                    <div class="app-card-body px-4 w-100">
                        ...
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <div class="item-label"><svg class="svg-inline--fa fa-cc-visa me-2"
                                            aria-hidden="true" focusable="false" data-prefix="fab"
                                            data-icon="cc-visa" role="img" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        </svg><!-- <i class="fab fa-cc-visa me-2"></i> Font Awesome fontawesome.com --><strong>Credit/Debit
                                            Card </strong></div>
                        ...
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                <div class="col-auto">
                                    <div class="item-label"><svg class="svg-inline--fa fa-paypal me-2"
                                            aria-hidden="true" focusable="false" data-prefix="fab"
                                        ...
                                        </svg><!-- <i class="fab fa-paypal me-2"></i> Font Awesome fontawesome.com --><strong>PayPal</strong>
                                    </div>
